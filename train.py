...
def main():
    ...
    parser.add_argument('train', type=bool, help='Set to True for training, False for testing')
    ...
    if train:
        ...
        valloader = torch.utils.data.DataLoader(valset, batch_size=2, shuffle = True, num_workers=4)
