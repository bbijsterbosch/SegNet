...
def main():
    ...
    if train:
        ...
        testloader = torch.utils.data.DataLoader(testset, batch_size=7, shuffle = True, num_workers=4)
        trainer_tester = segnet.Train_Test(model, device, trainloader,testloader, classes,  lr=0.1, momentum=0.9, epochs=500) 
